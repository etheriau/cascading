...
public class CascadingThreadFactory {
   public static class ThreadFactory {
     ...
     public Thread createThread( Runnable runnable, String name, boolean forceDaemon ) {
       Thread thread = new Thread( runnable, name );
       thread.setDaemon( forceDaemon );
       return thread;
     }
    ...
    * Creates a named thread for this runnable.
    */
   public static Thread createThread( Runnable runnable, String name, boolean forceDaemon ) {
     return threadFactory.createThread( runnable, name, forceDaemon );
   }
